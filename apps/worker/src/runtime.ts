 ...
 * together does not also hold a query (and stays under the size policy).
 */
async function readModelRow(prisma: PrismaClient, slug: string): Promise<ResolvedModelRow | null> {
