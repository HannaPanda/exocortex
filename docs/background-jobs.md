...
| `mail`                     | share notifications (#103) out of the outbox; the transport for the remaining notification mails of #104 to #107     | `createMailDeliveryProcessor`        | real (one SMTP hop, 5 attempts over ~8 min; a 5xx fails unrecoverably; issue #102)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
