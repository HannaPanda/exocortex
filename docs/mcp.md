...
| `exo_work_item_start_run`          | yes      | no          | `POST /api/work-items/:workItemId/runs` -- a built-in AI run in a conversation of its own; refused on a closed item or a spent budget                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
