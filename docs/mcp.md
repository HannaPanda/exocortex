...
| `exo_attention_list`               | no       | no          | `GET /api/attention?scope=&status=&workspaceId=&workItemId=&kind=&limit=` -- what waits on a person across workspaces (issue #139, ADR-067); `for_me` by default, `raised_by_me` is how an agent finds its answers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `exo_attention_get`                | no       | no          | `GET /api/attention/:attentionItemId` -- one item with who settled it and how                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `exo_attention_request`            | yes      | no          | `POST /api/workspaces/:workspaceId/attention` -- ask a person; on a work item a question moves it to `waiting_for_human`; `key` is idempotent                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
